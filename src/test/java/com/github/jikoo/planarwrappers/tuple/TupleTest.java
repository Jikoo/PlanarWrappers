...
class TupleTest {
  ...
  private static Stream<Arguments> getAccessors() {
    ...
    List<Arguments> arguments =
        Arrays.asList(
            Arguments.of(
                (Consumer<String>) pair::setLeft, (Supplier<String>) pair::getLeft, "Test value,"),
            Arguments.of(
                (Consumer<String>) pair::setRight,
                (Supplier<String>) pair::getRight,
                "please ignore."),
            Arguments.of(
                (Consumer<String>) triple::setLeft,
                (Supplier<String>) triple::getLeft,
                "Your cooperation"),
            Arguments.of(
                (Consumer<String>) triple::setMiddle,
                (Supplier<String>) triple::getMiddle,
                "is noted"),
            Arguments.of(
                (Consumer<String>) triple::setRight,
                (Supplier<String>) triple::getRight,
                "and appreciated."));
  ...
  private static Stream<Arguments> getEquals() {
    ...
    Pair<String, String> pairB =
        new Pair<>(
            pairA.getLeft().substring(0, 2) + pairA.getLeft().substring(2),
            pairA.getRight().substring(0, 2) + pairA.getRight().substring(2));
    Triple<String, String, String> tripleA =
        new Triple<>(pairA.getLeft(), "middle", pairA.getRight());
    Triple<String, String, String> tripleB =
        new Triple<>(
            pairB.getLeft(),
  ...
  private static Stream<Arguments> getInequals() {
    ...
    Triple<String, String, String> tripleA =
        new Triple<>(pairA.getLeft(), "middle", pairA.getRight());
    Triple<String, String, String> tripleB =
        new Triple<>(pairB.getLeft(), "amidships", pairB.getRight());
    Triple<String, String, String> tripleC =
        new Triple<>(pairA.getLeft(), "muddle", pairA.getRight());
